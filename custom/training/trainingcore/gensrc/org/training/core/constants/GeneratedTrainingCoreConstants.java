...
public class GeneratedTrainingCoreConstants
{
	...
	public static class TC
	{
		...
		public static final String BLOG = "blog".intern();
		public static final String COMMENTSTATUS = "commentStatus".intern();
		public static final String ELECTRONICSCOLORVARIANTPRODUCT = "ElectronicsColorVariantProduct".intern();
		public static final String POSTCOMMENTS = "postComments".intern();
		public static final String POSTS = "posts".intern();
		public static final String POSTSTATUS = "postStatus".intern();
	...
	{
		public static final String BLOG2POSTS = "Blog2Posts".intern();
		public static final String POSTS2COMMENTS = "Posts2Comments".intern();
	}
